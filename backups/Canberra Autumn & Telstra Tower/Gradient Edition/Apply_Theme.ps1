# Apply_Theme.ps1 - Canberra Autumn & Telstra Tower (Gradient Edition)

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Canberra Autumn & Telstra Tower (Gradient Edition)" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wpFile = "$PSScriptRoot\Canberra_Autumn_Wallpaper.jpg"
if (Test-Path $wpFile) {
...
$accentDword = [int]0xff0677d9
$colorizationDword = [int]-992381178
$palette = [byte[]]@(0xf5, 0xdd, 0xc0, 0x00, 0xec, 0xbb, 0x82, 0x00, 0xe2, 0x99, 0x44, 0x00, 0xd9, 0x77, 0x06, 0x00, 0xad, 0x5f, 0x04, 0x00, 0x82, 0x47, 0x03, 0x00, 0x56, 0x2f, 0x02, 0x00, 0x92, 0x40, 0x0e, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "217 119 6"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "217 119 6"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Canberra_Autumn_&_Telstra_Tower_Gradient_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Canberra Autumn & Telstra Tower (Gradient Edition) is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
