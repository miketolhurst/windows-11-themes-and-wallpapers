# Apply_Theme.ps1 - Canberra Parliament & Wattle

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Canberra Parliament & Wattle" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Canberra_Parliament_&_Wattle_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Canberra Parliament & Wattle is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
