# Apply_Theme.ps1 - Canberra Parliament & Wattle (Gradient Edition)

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Canberra Parliament & Wattle (Gradient Edition)" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wpFile = "$PSScriptRoot\Canberra_Parliament_Wallpaper.jpg"
if (Test-Path $wpFile) {
...
$accentDword = [int]0xff3d8400
$colorizationDword = [int]-1006599107
$palette = [byte[]]@(0xbf, 0xe0, 0xce, 0x00, 0x7f, 0xc1, 0x9e, 0x00, 0x3f, 0xa2, 0x6d, 0x00, 0x00, 0x84, 0x3d, 0x00, 0x00, 0x69, 0x30, 0x00, 0x00, 0x4f, 0x24, 0x00, 0x00, 0x34, 0x18, 0x00, 0xff, 0xcd, 0x00, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "0 132 61"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "0 132 61"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Canberra_Parliament_&_Wattle_Gradient_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Canberra Parliament & Wattle (Gradient Edition) is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
