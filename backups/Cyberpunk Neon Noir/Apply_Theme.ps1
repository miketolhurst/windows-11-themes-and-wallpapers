# Apply_Theme.ps1 - Cyberpunk Neon Noir

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Cyberpunk Neon Noir Theme" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wallpaperPath = (Resolve-Path "$PSScriptRoot\Cyberpunk_Wallpaper.jpg").Path
...
$accentDword = [int]0xff7f00ff
$colorizationDword = [int]-989921153
$palette = [byte[]]@(0xff, 0x99, 0xcc, 0x00, 0xff, 0x66, 0xb2, 0x00, 0xff, 0x33, 0x99, 0x00, 0xff, 0x00, 0x7f, 0x00, 0xcc, 0x00, 0x66, 0x00, 0x99, 0x00, 0x4c, 0x00, 0x66, 0x00, 0x33, 0x00, 0x00, 0xf3, 0xff, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "255 0 127"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "255 0 127"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Cyberpunk_Neon_Noir_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Cyberpunk Neon Noir theme is active!" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
