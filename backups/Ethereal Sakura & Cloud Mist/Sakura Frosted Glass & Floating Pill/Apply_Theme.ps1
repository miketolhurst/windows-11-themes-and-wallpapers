# Apply_Theme.ps1 - Sakura Frosted Glass & Floating Pill

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Sakura Frosted Glass & Floating Pill Theme" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
$accentDword = [int]0xffb672f4
$colorizationDword = [int]-990612810
$palette = [byte[]]@(0xfc, 0xdb, 0xec, 0x00, 0xf9, 0xb8, 0xda, 0x00, 0xf6, 0x95, 0xc8, 0x00, 0xf4, 0x72, 0xb6, 0x00, 0xc3, 0x5b, 0x91, 0x00, 0x92, 0x44, 0x6d, 0x00, 0x61, 0x2d, 0x48, 0x00, 0xc0, 0x84, 0xfc, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "244 114 182"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "244 114 182"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Sakura_Frosted_Glass_&_Floating_Pill_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Sakura Frosted Glass & Floating Pill theme is active!" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
