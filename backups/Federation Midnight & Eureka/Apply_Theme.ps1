# Apply_Theme.ps1 - Federation Midnight & Eureka

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Federation Midnight & Eureka" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Federation_Midnight_&_Eureka_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Federation Midnight & Eureka is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
