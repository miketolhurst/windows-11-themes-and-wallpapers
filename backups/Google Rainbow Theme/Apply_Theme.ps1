# Apply_Theme.ps1 - Google Rainbow Theme

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Google Rainbow Theme" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wpFile = "$PSScriptRoot\Google_Assistant_Kinetic_Wave_Wallpaper.jpg"
if (Test-Path $wpFile) {
...
$accentDword = [int]0xff05bcfb
$colorizationDword = [int]-990135291
$palette = [byte[]]@(0xfe, 0xee, 0xc0, 0x00, 0xfd, 0xdd, 0x82, 0x00, 0xfc, 0xcc, 0x43, 0x00, 0xfb, 0xbc, 0x05, 0x00, 0xc8, 0x96, 0x04, 0x00, 0x96, 0x70, 0x03, 0x00, 0x64, 0x4b, 0x02, 0x00, 0x42, 0x85, 0xf4, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "251 188 5"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "251 188 5"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Google_Rainbow_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Google Rainbow Theme is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
