# Apply_Theme.ps1 - Sunset Synthwave & Outrun

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Sunset Synthwave & Outrun Theme" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wpFile = "$PSScriptRoot\Synthwave_Sunset_Wallpaper.jpg"
if (Test-Path $wpFile) {
...
$accentDword = [int]0xff2257ff
$colorizationDword = [int]-989898974
$palette = [byte[]]@(0xff, 0xd5, 0xc7, 0x00, 0xff, 0xab, 0x90, 0x00, 0xff, 0x81, 0x59, 0x00, 0xff, 0x57, 0x22, 0x00, 0xcc, 0x45, 0x1b, 0x00, 0x99, 0x34, 0x14, 0x00, 0x66, 0x22, 0x0d, 0x00, 0xe9, 0x1e, 0x63, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "255 87 34"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "255 87 34"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Sunset_Synthwave_&_Outrun_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Sunset Synthwave & Outrun theme is active!" -ForegroundColor Magenta
Write-Host "=========================================================" -ForegroundColor Cyan
