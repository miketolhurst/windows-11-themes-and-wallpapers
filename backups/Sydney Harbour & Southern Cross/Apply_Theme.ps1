# Apply_Theme.ps1 - Sydney Harbour & Southern Cross

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Sydney Harbour & Southern Cross" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Sydney_Harbour_&_Southern_Cross_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Sydney Harbour & Southern Cross is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
