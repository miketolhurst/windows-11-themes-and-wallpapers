# Apply_Theme.ps1 - Sydney Harbour & Southern Cross (Gradient Edition)

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Sydney Harbour & Southern Cross (Gradient Edition)" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""

# 1. Desktop Wallpaper
Write-Host "[1/4] Setting Desktop Wallpaper..." -ForegroundColor Yellow
$wpFile = "$PSScriptRoot\Sydney_Harbour_Wallpaper.jpg"
if (Test-Path $wpFile) {
...
$accentDword = [int]0xff37afd4
$colorizationDword = [int]-992694473
$palette = [byte[]]@(0xf4, 0xeb, 0xcd, 0x00, 0xe9, 0xd7, 0x9b, 0x00, 0xde, 0xc3, 0x69, 0x00, 0xd4, 0xaf, 0x37, 0x00, 0xa9, 0x8c, 0x2c, 0x00, 0x7f, 0x69, 0x21, 0x00, 0x54, 0x46, 0x16, 0x00, 0x1e, 0x3a, 0x8a, 0x00)
...
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "Hilight" -Value "212 175 55"
Set-ItemProperty -Path "HKCU:\Control Panel\Colors" -Name "HotTrackingColor" -Value "212 175 55"
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Sydney_Harbour_&_Southern_Cross_Gradient_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Sydney Harbour & Southern Cross (Gradient Edition) is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
