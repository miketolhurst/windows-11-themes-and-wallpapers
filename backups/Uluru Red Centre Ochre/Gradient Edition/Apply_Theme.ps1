# Apply_Theme.ps1 - Uluru Red Centre Ochre (Gradient Edition)

Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Applying Uluru Red Centre Ochre (Gradient Edition)" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
...
$regPath = (Resolve-Path "$PSScriptRoot\Apply_Uluru_Red_Centre_Ochre_Gradient_Theme.reg").Path
...
Write-Host ""
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host " Done! Uluru Red Centre Ochre (Gradient Edition) is active!" -ForegroundColor Yellow
Write-Host "=========================================================" -ForegroundColor Cyan
